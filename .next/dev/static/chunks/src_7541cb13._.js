...
"[project]/src/context/MapContext.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const MapContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["createContext"])();
function MapProvider({ children }) {
    ...
    const [zoom, setZoom] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(2);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(MapContext.Provider, {
        value: {
            center,
            zoom,
            setCenter,
...
_s(MapProvider, "2N3bFXYmZlgtyODPhjK2Sxd6yWU=");
_c = MapProvider;
const useMapContext = ()=>{
    _s1();
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useContext"])(MapContext);
};
_s1(useMapContext, "gDsCjeeItUuvgOWf1v4qoK9RF6k=");
var _c;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$MapContext$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/context/MapContext.js [client] (ecmascript)"); // Import the context
;
var _s = __turbopack_context__.k.signature(), _s1 = __turbopack_context__.k.signature();
;
;
...
function MapStateManager() {
    _s();
    const { setCenter, setZoom } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$MapContext$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useMapContext"])();
    useMapEvents({
        moveend: {
...
_s(MapStateManager, "N3uIMMdkxTx6TIU+e6th+iPGnYY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$MapContext$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useMapContext"],
        useMapEvents
    ];
});
_c = MapStateManager;
const Map = ({ className, snacks = [] })=>{
    ...
    const { center, zoom } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$MapContext$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useMapContext"])(); // Get state from context
...
//# sourceMappingURL=src_7541cb13._.js.map